    ...
    *,
    ...
    if attribution_workflow:
        ...
        if attribution_ffl_url:
            ...
            ffl_link = ""
        attribution_html = (
            f'<div class="attribution">Generated by Facetwork workflow '
            f"<code>{wf}</code>{ffl_link} &middot; generated {_ts}</div>"
        )
    else:
        attribution_html = (
            '<div class="attribution">Generated with '
            '<a href="https://github.com/rlemke/facetwork" target="_blank" '
            f'rel="noopener">Facetwork</a> &middot; generated {_ts}</div>'
        )
